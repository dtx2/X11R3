...
/* $Header: vgaSolid.c,v 6.0 88/08/18 08:57:13 erik Exp $ */
/* $Source: /vice/X11/r3/server/ddx/ibm/vga/RCS/vgaSolid.c,v $ */

#ifndef lint
static char *rcsid = "$Header: vgaSolid.c,v 6.0 88/08/18 08:57:13 erik Exp $";
#endif
