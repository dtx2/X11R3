...
/* $Header: /andrew/X11/R3src/tape/server/ddx/ibm/mpel/RCS/mpelTile.c,v 6.3 88/10/25 01:09:32 kbg Exp $ */
/* $Source: /andrew/X11/R3src/tape/server/ddx/ibm/mpel/RCS/mpelTile.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /andrew/X11/R3src/tape/server/ddx/ibm/mpel/RCS/mpelTile.c,v 6.3 88/10/25 01:09:32 kbg Exp $";
#endif
    ...
    int x, y, w, h, xSrc, ySrc;
{
    ...
    if ( xrot || yrot ) {
	if (!( pRotTile =
		ppcCreatePixmap( pTile->drawable.pScreen,
			tilew, tileh, pTile->drawable.depth ))) {
